...
npm test        # engine unit tests (140, all passing)
```
...
| `engine/*.test.mjs` | done — 140 tests passing |
...
1. `npm test` — 140 tests. Engine checks, corrections, replanning and the trust boundary, plus
